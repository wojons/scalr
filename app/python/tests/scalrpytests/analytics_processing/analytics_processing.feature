Feature: Analytics Processing
    ...
    Scenario Outline: Calculate poller data
        ...
        Analytics database has managed records
            ...
            | 00000000-0000-0000-0000-000000000001 | 10000000-0000-0000-0000-000000000000 | 'm1.small'    | 0  | i-00000000  |
            ...
            | 00000000-0000-0000-0000-000000000003 | 30000000-0000-0000-0000-000000000004 | 'm1.small'    | 0  | i-00000004  |

        Database has servers records
            | server_id                              | farm_id | farm_roleid | env_id | os_type   | client_id |
            | '10000000-0000-0000-0000-000000000000' | 1       | 1           | 1      | 'linux'   | 1         |
            ...
            | '30000000-0000-0000-0000-000000000004' | 3       | 3           | 2      | 'linux'   | 2         |
        ...
        Database has servers_history records
            ...
            | '10000000-0000-0000-0000-000000000000' | 1       | 'i-00000000'    | 1      | 1         | 00000000-0000-0000-0000-00000000000a | 00000000-0000-0000-0000-00000000000b | 1            | 111     |
            ...
            | '30000000-0000-0000-0000-000000000004' | 3       | 'i-00000004'    | 2      | 2         | 00000000-0000-0000-0000-00000000000a | 00000000-0000-0000-0000-00000000000b | 3            | 111     |
        ...
        White Rabbit checks farm_usage_d table
            | date         | account_id | farm_role_id | cc_id                                | project_id                           | platform | cloud_location | env_id | farm_id | role_id | usage_items.name | cost        | min_usage | max_usage | usage_hours | working_hours |
            | '2015-05-01' | 1          |            1 | 00000000-0000-0000-0000-00000000000b | 00000000-0000-0000-0000-00000000000a | 'ec2'    | 'us-west-1'    |      1 |       1 |     111 | 'm1.small'       | 3.000000000 |      0.00 |      3.00 |        3.00 |             1 |
            | '2015-05-01' | 1          |            2 | 00000000-0000-0000-0000-00000000000b | 00000000-0000-0000-0000-00000000000a | 'ec2'    | 'us-west-1'    |      1 |       2 |     111 | 'm1.medium'      | 2.500000000 |      0.00 |      1.00 |        1.00 |             1 |
            | '2015-05-01' | 2          |            3 | 00000000-0000-0000-0000-00000000000b | 00000000-0000-0000-0000-00000000000a | 'ec2'    | 'us-west-2'    |      2 |       3 |     111 | 'm1.small'       | 1.500000000 |      0.00 |      1.00 |        1.00 |             1 |
    ...
    Scenario Outline: Recalculate poller data
        ...
        White Rabbit checks farm_usage_d table
            | date         | account_id | farm_role_id | cc_id                                | project_id                           | platform | cloud_location | env_id | farm_id | role_id | usage_items.name | cost        | min_usage | max_usage | usage_hours | working_hours |
            | '2015-05-01' |          1 |            1 | 00000000-0000-0000-0000-00000000000b | 00000000-0000-0000-0000-00000000000a | 'ec2'    | 'us-west-1'    |      1 |       1 |     111 | 'm1.small'       | 6.000000000 |      0.00 |      3.00 |        3.00 |             1 |
            | '2015-05-01' |          1 |            2 | 00000000-0000-0000-0000-00000000000b | 00000000-0000-0000-0000-00000000000a | 'ec2'    | 'us-west-1'    |      1 |       2 |     111 | 'm1.medium'      | 5.000000000 |      0.00 |      1.00 |        1.00 |             1 |
            | '2015-05-01' |          2 |            3 | 00000000-0000-0000-0000-00000000000b | 00000000-0000-0000-0000-00000000000a | 'ec2'    | 'us-west-2'    |      2 |       3 |     111 | 'm1.small'       | 3.000000000 |      0.00 |      1.00 |        1.00 |             1 |
    ...
    Scenario Outline: Amazon detailed billing
        ...
        Database has servers records
            ...
            | '10000000-0000-0000-0000-000000000000' | 1       | 1           | 'm1.small' | 'linux' | 1         | 'ec2'    | 1      |
            | '10000000-0000-0000-0000-000000000002' | 1       | 1           | 'm1.small' | 'linux' | 1         | 'ec2'    | 1      |

        Database has servers_history records
            | server_id                              | cloud_server_id | project_id                           | cc_id                                | role_id |
            | '10000000-0000-0000-0000-000000000000' | 'i-00000000'    | 00000000-0000-0000-0000-00000000000a | 00000000-0000-0000-0000-00000000000b | 111     |
            | '10000000-0000-0000-0000-000000000002' | 'i-00000002'    | 00000000-0000-0000-0000-00000000000a | 00000000-0000-0000-0000-00000000000b | 111     |
        ...
        White Rabbit checks usage_h table
            ...
            | 1          | '2015-05-01 02:00:00' | 'ec2'    | 'us-east-1'    | 1                           | 'BoxUsage'       |'m1.small'        | 0  | 00000000-0000-0000-0000-00000000000b | 00000000-0000-0000-0000-00000000000a | 1      | 1       | 1            | 111     | 1.00   | 0.044000000 |
            | 1          | '2015-05-01 03:00:00' | 'ec2'    | 'us-east-1'    | 1                           | 'BoxUsage'       |'m1.small'        | 0  | 00000000-0000-0000-0000-00000000000b | 00000000-0000-0000-0000-00000000000a | 1      | 1       | 1            | 111     | 1.00   | 0.044000000 |
            | 1          | '2015-05-01 03:00:00' | 'ec2'    | 'us-east-1'    | 2                           | 'EBS'            |'standard'        | 0  | 00000000-0000-0000-0000-00000000000b | 00000000-0000-0000-0000-00000000000a | 1      | 1       | 1            | 111     | 1.03   | 0.000069440 |
            | 1          | '2015-05-01 03:00:00' | 'ec2'    | 'us-east-1'    | 2                           | 'EBS IO'         |'io'              | 0  | 00000000-0000-0000-0000-00000000000b | 00000000-0000-0000-0000-00000000000a | 1      | 1       | 1            | 111     | 227.00 | 0.000011350 |

        White Rabbit checks usage_d table
            | date          | platform | cc_id                                | project_id                           | farm_id | cost        |
            | '2015-05-01 ' | 'ec2'    | 00000000-0000-0000-0000-00000000000b | 00000000-0000-0000-0000-00000000000a | 1       | 0.132080790 |

        White Rabbit checks farm_usage_d table
            | date         | account_id | farm_role_id | cc_id                                | project_id                           | platform | cloud_location | env_id | farm_id | role_id | usage_items.name | cost        | min_usage | max_usage | usage_hours | working_hours |
            | '2015-05-01' | 1          |            1 | 00000000-0000-0000-0000-00000000000b | 00000000-0000-0000-0000-00000000000a | 'ec2'    | 'us-east-1'    |      1 |       1 |     111 | 'm1.small'       | 0.132000000 |      0.00 |      1.00 |        3.00 |             3 |
            | '2015-05-01' | 1          |            1 | 00000000-0000-0000-0000-00000000000b | 00000000-0000-0000-0000-00000000000a | 'ec2'    | 'us-east-1'    |      1 |       1 |     111 | 'standard'       | 0.000069440 |      0.00 |      1.03 |        1.03 |             1 |
            | '2015-05-01' | 1          |            1 | 00000000-0000-0000-0000-00000000000b | 00000000-0000-0000-0000-00000000000a | 'ec2'    | 'us-east-1'    |      1 |       1 |     111 | 'io'             | 0.000011350 |      0.00 |    227.00 |      227.00 |             1 |
    ...
    Scenario Outline: Amazon detailed billing file not ok
        ...
        Database has servers records
            | server_id                              | farm_id | farm_roleid | type       | os_type | client_id |
            | '10000000-0000-0000-0000-000000000000' | 1       | 1           | 'm1.small' | 'linux' | 1         |
    ...
    Scenario Outline: Amazon detailed billing with custom PayerAccount
        ...
        White Rabbit checks usage_h table
            | account_id | dtime                 | platform | cloud_location |usage_types.cost_distr_type | usage_types.name | usage_items.name | os | cc_id                                | project_id                           | env_id | farm_id | farm_role_id | role_id | num  | cost        |
            | 1          | '2015-05-01 01:00:00' | 'ec2'    | 'us-east-1'    |1                           | 'BoxUsage'       | 'm1.small'       | 0  | 00000000-0000-0000-0000-00000000000b | 00000000-0000-0000-0000-00000000000a | 1      | 1       | 1            | 111     | 1.00 | 0.044000000 |

        White Rabbit checks usage_d table
            | date          | platform | cc_id                                  | project_id                             | farm_id | cost        |
            | '2015-05-01 ' | 'ec2'    | '00000000-0000-0000-0000-00000000000b' | '00000000-0000-0000-0000-00000000000a' | 1       | 0.044000000 |

        White Rabbit checks farm_usage_d table
            | date         | account_id | farm_role_id | cc_id                                | project_id                           | platform | cloud_location | env_id | farm_id | role_id | usage_items.name | cost        | min_usage | max_usage | usage_hours | working_hours |
            | '2015-05-01' | 1          |            1 | 00000000-0000-0000-0000-00000000000b | 00000000-0000-0000-0000-00000000000a | 'ec2'    | 'us-east-1'    |      1 |       1 |     111 | 'm1.small'       | 0.044000000 |      0.00 |      1.00 |        1.00 |             1 |
    ...
    Scenario Outline: Azure billing
        ...
        White Rabbit checks usage_h table
            ...
            | 1          | '2015-04-30 08:00:00' | 'azure'  | 'eastus'       | 4                           | 'Software'       | 'Red Hat Enterprise Linux (2 core)' | 0  | '00000000-0000-0000-0000-00000000000b' | 00000000-0000-0000-0000-00000000000a | 1      | 1       | 1            | 111     | 1.00  | 0.000100000 |

        White Rabbit checks usage_d table
            | date          | platform | cc_id                                  | project_id                             | farm_id | cost        |
            | '2015-04-30 ' | 'azure'  | '00000000-0000-0000-0000-00000000000b' | '00000000-0000-0000-0000-00000000000a' | 1       | 0.000298000 |

        White Rabbit checks farm_usage_d table
            | date         | account_id | farm_role_id | cc_id                                | project_id                           | platform | cloud_location | env_id | farm_id | role_id | usage_items.name                    | cost        | min_usage | max_usage | usage_hours | working_hours |
            | '2015-04-30' | 1          |            1 | 00000000-0000-0000-0000-00000000000b | 00000000-0000-0000-0000-00000000000a | 'azure'  | 'eastus'       |      1 |       1 |     111 | 'Basic_A0'                          | 0.000198000 |      0.00 |      1.00 |        1.00 |             1 |
            | '2015-04-30' | 1          |            1 | 00000000-0000-0000-0000-00000000000b | 00000000-0000-0000-0000-00000000000a | 'azure'  | 'eastus'       |      1 |       1 |     111 | 'Red Hat Enterprise Linux (2 core)' | 0.000100000 |      0.00 |      1.00 |        1.00 |             1 |


    Scenario Outline: Recalculate Amazon detailed billing with missing scalr-meta
        White Rabbit stops system service 'mysql'
        White Rabbit starts system service 'mysql'
        White Rabbit has config '../../../tests/etc/config.yml'
        White Rabbit drops scalr_test database
        ...
        Database has servers records
            ...
            | '10000000-0000-0000-0000-000000000030' | NULL    | NULL        | 'm1.small' | 'linux' | 1         | 'ec2'    | 1      |

        Database has servers_history records
            | server_id                              | cloud_server_id | project_id                           | cc_id                                | role_id |
            | '10000000-0000-0000-0000-000000000000' | 'i-00000000'    | 00000000-0000-0000-0000-00000000000a | 00000000-0000-0000-0000-00000000000b | 111     |
            | '10000000-0000-0000-0000-000000000001' | 'i-00000001'    | 00000000-0000-0000-0000-00000000000a | 00000000-0000-0000-0000-00000000000b | 111     |
            | '10000000-0000-0000-0000-000000000030' | 'i-00000030'    | 00000000-0000-0000-0000-00000000000a | 00000000-0000-0000-0000-00000000000b | 111     |

        Database has client_environment_properties records
            | env_id | name    | value                                  |
            | 1      | 'cc_id' | '00000000-0000-0000-0000-00000000000b' |

        White Rabbit starts Analytics Processing script with options '-c ../../../tests/etc/config.yml --recalculate --billing aws-detailed-billing --year 2015 --quarter 1 -v DEBUG'
        White Rabbit waits 5 seconds
        White Rabbit stops Analytics Processing script

        White Rabbit checks usage_h table
            | account_id | dtime                 | platform | cloud_location | usage_types.cost_distr_type | usage_types.name | usage_items.name | os | cc_id                                | project_id                           | env_id | farm_id | farm_role_id | role_id | num  | cost        |
            | 1          | '2015-03-01 00:00:00' | 'ec2'    | 'us-east-1'    | 1                           | 'BoxUsage'       |'m1.small'        | 0  | 00000000-0000-0000-0000-00000000000b | 00000000-0000-0000-0000-00000000000a | 1      | 1       | 1            | 111     | 2.00 | 0.088000000 |
            | 1          | '2015-03-01 01:00:00' | 'ec2'    | 'us-east-1'    | 1                           | 'BoxUsage'       |'m1.small'        | 0  | 00000000-0000-0000-0000-00000000000b | 00000000-0000-0000-0000-00000000000a | 1      | 1       | 1            | 111     | 1.00 | 0.044000000 |
            | 1          | '2015-03-01 02:00:00' | 'ec2'    | 'us-east-1'    | 1                           | 'BoxUsage'       |'m1.small'        | 0  | 00000000-0000-0000-0000-00000000000b | 00000000-0000-0000-0000-00000000000a | 1      | 1       | 1            | 111     | 1.00 | 0.044000000 |
            | 1          | '2015-03-01 03:00:00' | 'ec2'    | 'us-east-1'    | 1                           | 'BoxUsage'       |'m1.small'        | 0  | 00000000-0000-0000-0000-00000000000b | 00000000-0000-0000-0000-00000000000a | 1      | 1       | 1            | 111     | 2.00 | 0.088000000 |

        White Rabbit checks usage_d table
            | date          | platform | cc_id                                | project_id                           | farm_id | cost        |
            | '2015-03-01 ' | 'ec2'    | 00000000-0000-0000-0000-00000000000b | 00000000-0000-0000-0000-00000000000a | 1       | 0.264000000 |

        White Rabbit checks farm_usage_d table
            | date         | account_id | farm_role_id | cc_id                                | project_id                           | platform | cloud_location | env_id | farm_id | role_id | usage_items.name | cost        | min_usage | max_usage | usage_hours | working_hours |
            | '2015-03-01' | 1          |            1 | 00000000-0000-0000-0000-00000000000b | 00000000-0000-0000-0000-00000000000a | 'ec2'    | 'us-east-1'    |      1 |       1 |     111 | 'm1.small'       | 0.264000000 |      0.00 |      2.00 |        6.00 |             4 |
