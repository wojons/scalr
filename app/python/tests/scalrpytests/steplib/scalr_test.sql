...
) ENGINE=InnoDB AUTO_INCREMENT=52128 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `ssh_keys` (
  ...
  CONSTRAINT `fk_ssh_keys_farms_id` FOREIGN KEY (`farm_id`) REFERENCES `farms` (`id`) ON DELETE CASCADE ON UPDATE NO ACTION
) ENGINE=InnoDB AUTO_INCREMENT=71 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `syslog` (
  ...
  KEY `idx_dtadded` (`dtadded`)
) ENGINE=MyISAM AUTO_INCREMENT=19021 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `syslog_0502092014`
--

DROP TABLE IF EXISTS `syslog_0502092014`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `syslog_0502092014` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `dtadded` datetime DEFAULT NULL,
  `message` text,
  `severity` varchar(10) DEFAULT NULL,
  ...
  KEY `NewIndex2` (`sub_transactionid`),
  KEY `idx_dtadded` (`dtadded`)
) ENGINE=MyISAM AUTO_INCREMENT=1982066 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `syslog_0504092014`
--

DROP TABLE IF EXISTS `syslog_0504092014`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `syslog_0504092014` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `dtadded` datetime DEFAULT NULL,
  `message` text,
  `severity` varchar(10) DEFAULT NULL,
  ...
  KEY `NewIndex2` (`sub_transactionid`),
  KEY `idx_dtadded` (`dtadded`)
) ENGINE=MyISAM AUTO_INCREMENT=2023963 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `syslog_0525082014`
--

DROP TABLE IF EXISTS `syslog_0525082014`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `syslog_0525082014` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `dtadded` datetime DEFAULT NULL,
  `message` text,
  `severity` varchar(10) DEFAULT NULL,
  ...
  KEY `NewIndex2` (`sub_transactionid`),
  KEY `idx_dtadded` (`dtadded`)
) ENGINE=MyISAM AUTO_INCREMENT=1895498 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `syslog_0526082014`
--

DROP TABLE IF EXISTS `syslog_0526082014`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `syslog_0526082014` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `dtadded` datetime DEFAULT NULL,
  `message` text,
  `severity` varchar(10) DEFAULT NULL,
  ...
  KEY `NewIndex2` (`sub_transactionid`),
  KEY `idx_dtadded` (`dtadded`)
) ENGINE=MyISAM AUTO_INCREMENT=1019989 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `syslog_0528082014`
--

DROP TABLE IF EXISTS `syslog_0528082014`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `syslog_0528082014` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `dtadded` datetime DEFAULT NULL,
  `message` text,
  `severity` varchar(10) DEFAULT NULL,
  ...
  KEY `NewIndex2` (`sub_transactionid`),
  KEY `idx_dtadded` (`dtadded`)
) ENGINE=MyISAM AUTO_INCREMENT=1916557 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `syslog_0529082014`
--

DROP TABLE IF EXISTS `syslog_0529082014`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `syslog_0529082014` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `dtadded` datetime DEFAULT NULL,
  `message` text,
  `severity` varchar(10) DEFAULT NULL,
  ...
  KEY `NewIndex2` (`sub_transactionid`),
  KEY `idx_dtadded` (`dtadded`)
) ENGINE=MyISAM AUTO_INCREMENT=1004485 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `syslog_0531082014`
--

DROP TABLE IF EXISTS `syslog_0531082014`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `syslog_0531082014` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `dtadded` datetime DEFAULT NULL,
  `message` text,
  `severity` varchar(10) DEFAULT NULL,
  ...
  KEY `NewIndex2` (`sub_transactionid`),
  KEY `idx_dtadded` (`dtadded`)
) ENGINE=MyISAM AUTO_INCREMENT=1979063 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2014-09-04  5:44:12
