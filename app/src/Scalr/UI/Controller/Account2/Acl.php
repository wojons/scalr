...
class Scalr_UI_Controller_Account2_Acl extends Scalr_UI_Controller
{
    ...
    {
        $this->response->page('ui/account2/acl/view.js', array(
            'definitions' => Acl::getResources(true)
        ), array('ui/account2/dataconfig.js'), array('ui/account2/acl/view.css'), array('account.acl', 'base.acl'));
    }
    ...
    public function usageAction($accountRoleId)
    {
        ...
        $this->response->page('ui/account2/acl/usage.js', array(
