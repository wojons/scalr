...
class Scalr_UI_Controller_Account2_Billing extends Scalr_UI_Controller
{
    ...
    {
        $this->response->page('ui/account2/billing/reactivate.js', array('billing' => $this->billing->getInfo()));
    }
    ...
    public function invoicesListAction()
    {
        ...
        $this->response->page('ui/account2/billing/invoices.js', array('invoices' => $invoices));
    }
    ...
    {
        $this->response->page('ui/account2/billing/applyCouponCode.js');
    }
...
#billing_statement_summary_balance_paid_stamp {text-align: right;color: #ff0000;font-size: 18px;}
    ...
    public function changePlanAction()
    {
        ...
        $this->response->page('ui/account2/billing/changePlan.js', array(
        ...
        ), array(), array('ui/account2/billing/changePlan.css'));
    }
    ...
    public function updateCreditCardAction()
    {
        ...
        $this->response->page('ui/account2/billing/updateCreditCard.js', array(
    ...
    public function detailsAction()
    {
        ...
        $this->response->page('ui/account2/billing/details.js', array(
            'billing' => $info,
