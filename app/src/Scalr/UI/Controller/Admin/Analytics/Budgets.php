...
class Scalr_UI_Controller_Admin_Analytics_Budgets extends Scalr_UI_Controller
{
    ...
    {
        $this->response->page('ui/admin/analytics/budgets/view.js', array(
    ...
    {
        $this->response->page('ui/admin/analytics/budgets/quarterCalendar.js', array(
            'quarters' => SettingEntity::getQuarters(true),
            'quartersConfirmed' => SettingEntity::getValue(SettingEntity::ID_QUARTERS_DAYS_CONFIRMED)
        ));
    }
    ...
    {
        $ccId = $ccId == 'root' ? null : $ccId;//extjs5.1
        $quarters = new Quarters(SettingEntity::getQuarters(true));
