...
class Scalr_UI_Controller_Analytics extends Scalr_UI_Controller
{
    use Forecast;
     ...
     *
     * @param   string      $farmId       Identifier of the Farm
     ...
     */
    public function xGetUsageItemsAction($farmId, $farmRoleId = null, $mode, $date, $start, $end)
    {
        ...
        $data = $this->getContainer()->analytics->usage->getFarmPointData(
            $this->user->getAccountId(), null, $this->getEnvironmentId(), $farmId, $farmRoleId, $mode, $date, $start, $end
        );
