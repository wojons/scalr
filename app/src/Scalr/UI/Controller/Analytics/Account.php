...
class Scalr_UI_Controller_Analytics_Account extends Scalr_UI_Controller
{
    ...
    public function xGetPeriodCsvAction($mode, $startDate, $endDate, $type, $envId = null, $projectId = null)
    {
        ...
        if (!empty($envId)) {
            ...
            $fileName = 'Environment' . $this->environment->id . '.' . $entity->name . '.' . $entity->getProperty('billing.code');
        } else {
