...
class Update20140314081808 extends AbstractUpdate implements SequenceInterface
{
    ...
    protected $description = 'Creating Webhooks ACL resource ';
    ...
    {
        return defined('Scalr\\Acl\\Acl::RESOURCE_GENERAL_WEBHOOKS') && $this->db->GetOne("
    ...
    {
        return defined('Scalr\\Acl\\Acl::RESOURCE_GENERAL_WEBHOOKS') &&
               Definition::has(Acl::RESOURCE_GENERAL_WEBHOOKS);
    }
