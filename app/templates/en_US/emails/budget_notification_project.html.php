...
<td class="title3" style="width:240px;border-collapse:collapse;font-size: 13px;color: #5997BF;text-transform: uppercase;font-weight: bold;line-height: 40px">Top 5 farms</td>
        ...
        <td class="title3" style="border-collapse:collapse;font-size: 13px;color: #5997BF;text-transform: uppercase;font-weight: bold;line-height: 40px">Weekly average</td>
    </tr>
...
<td class="title4" style="padding:0 60px 0 0;border-collapse:collapse;font-size: 13px;line-height: 24px;font-weight: bold;color: #1A487B;padding-bottom: 16px"><?=$farm['name'] ? $farm['name'] : 'Other farms'?></td>
            ...
            <td class="title4" style="border-collapse:collapse;font-size: 13px;line-height: 24px;font-weight: bold;color: #1A487B;padding-bottom: 16px"><?=round($farm['averageCost']) ? '$'.number_format(round($farm['averageCost']), 0, '.', ',') : '&ndash;'?></td>
        </tr>
<?php endforeach?>
</table>
</td>
