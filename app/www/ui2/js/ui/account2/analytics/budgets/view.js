Scalr.regPage('Scalr.ui.account2.analytics.budgets.view', function (loadParams, moduleParams) {
                ...
                cb1 = function() {
                    ...
                    if (!projectId) {
                        ...
                        if (node) {
                            node.expand();
                            if (node) {
                                node = node.findChild('id', projectId);
                                if (node) selModel.select(node);
                            }
                        }
                    }
                };
	...
	var store = Ext.create('Ext.data.TreeStore', {
		...
		proxy: {
			type: 'ajax',
			url: '/account/analytics/budgets/xList',
            reader: {
                type: 'json',
                rootProperty: 'nodes',
                transform: {
    ...
    var treepanel = Ext.widget({
        ...
        dockedItems: [{
            ...
            items: [{
                ...
                xtype: 'component',
                minWidth: 106,
                html: '<div class="x-semibold" style="font-size:13px;line-height:20px">Budget</div>'
            }]
        }]
    ...
    var form = Ext.create('Ext.form.Panel', {
        ...
        loadBudgetInfo: function(record) {
            ...
            me.currentRequest = Scalr.Request({
                url: '/account/analytics/budgets/xGetBudgetInfo',
                params: {
            ...
            items: [{
                ...
                handler: function() {
                    ...
                    Scalr.Request({
                        ...
                        url: '/account/analytics/budgets/xSave/',
                        success: function (data) {
                            Scalr.event.fireEvent('update', '/account/analytics/budgets/edit');
