Scalr.regPage('Scalr.ui.account2.analytics.notifications.view', function (loadParams, moduleParams) {
    ...
    var panel = Ext.create('Ext.panel.Panel', {
        ...
        saveOption: function(){
            ...
            Scalr.Request({
                ...
                url: '/account/analytics/notifications/xSave/',
                params: {
            ...
            items: [{
                ...
                selModel: {
                    ...
                    getVisibility: function(record) {
                        return record.get('accountId') == Scalr.user.clientId;
                    }
                },
                flex: 1,
                ...
                store: {
                    fields: [
                        ...
                        'subjectType',
                        {name: 'subjectId', convert: function(v, record){return v || ''}},
                        'notificationType',
                        'threshold',
                ...
                features: {
                    ...
                    handler: function(view) {
                        var grid = view.up();
                        grid.store.add({subjectType: grid.up('panel').currentId === 2, status: 1});
                    }
                },
                listeners: {
                ...
                getValues: function() {
                    ...
                    store.getUnfiltered().each(function(record){
                        var colIndex;
                        if (record.get('accountId') != Scalr.user.clientId) {
                            return;
                        }
                ...
                columns: [{
                    ...
                    onWidgetAttach: function(column, widget, record) {
                        widget.setReadOnly(record.get('accountId') != Scalr.user.clientId);
                    },
                    widget: {
                        xtype: 'combo',
                        store: {
                    ...
                    widget: {
                        ...
                        setSubjectType: function(subjectType) {
                            ...
                            this.store.load({data: moduleParams['projects'], addRecords: true});
                ...
                store: {
                    fields: [
                        {name: 'uuid', defaultValue: ''},
                        {name: 'subjectType', convert: function(v, record){return v || 2}},
                        {name: 'subjectId', convert: function(v, record){return v || ''}},
