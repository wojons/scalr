Scalr.regPage('Scalr.ui.admin.analytics.costcenters.notifications', function (loadParams, moduleParams) {
            ...
            items: [{
                ...
                handler: function() {
                    ...
                    Scalr.Request({
                        ...
                        url: '/admin/analytics/costcenters/xSaveNotifications/',
                        params: {
                            ccId: loadParams['ccId'],
