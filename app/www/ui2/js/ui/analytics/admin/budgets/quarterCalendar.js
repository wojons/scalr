Scalr.regPage('Scalr.ui.analytics.admin.budgets.quarterCalendar', function (loadParams, moduleParams) {
				...
				handler: function() {
					...
					if (frm.isValid())
						Scalr.Request({
							...
							form: frm,
							url: '/analytics/budgets/xSaveQuarterCalendar',
							success: function (data) {
                                Scalr.utils.Quarters.days = data['quarters'];
								Scalr.event.fireEvent('redirect', '#/analytics/budgets/');
							}
						});
				}
			}, {
