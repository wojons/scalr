            ...
            if (moduleParams['dbType'] == 'mysql' || moduleParams['dbType'] == 'mysql2' || moduleParams['dbType'] == 'percona') {
                if (item['replicationRole'] == 'Master') {
                    items.push({
                        ...
                        value: '<div style="margin-right: 5px" class="x-grid-icon x-grid-icon-simple x-grid-icon-ok"></div>' + item['masterPosition']
                    });
                }
                else {
                    if (! item['data'])
                    ...
                    items.push({
                        ...
                        value: '<div style="margin-right: 5px" class="x-grid-icon x-grid-icon-simple x-grid-icon-' + (item['data']['Slave_IO_Running'] === 'Yes' ? 'ok' : 'error') + '"></div>' + item['data']['Slave_IO_Running']
                    });
                    ...
                    items.push({
                        ...
                        value: '<div style="margin-right: 5px" class="x-grid-icon x-grid-icon-simple x-grid-icon-' + (item['data']['Slave_SQL_Running'] === 'Yes' ? 'ok' : 'error') + '"></div>' + item['data']['Slave_SQL_Running']
                    });
                    ...
                    items.push({
                        ...
                        value: '<div style="margin-right: 5px" class="x-grid-icon x-grid-icon-simple x-grid-icon-' + (item['data']['Seconds_Behind_Master'] == 0 ? 'ok' : 'error') + '"></div>' + item['data']['Seconds_Behind_Master']
                    });
                }
            }
