Ext.define('Scalr.ui.FarmRoleEditorTab.Mysql', {
    ...
    __items: [{
        ...
        items: [{
            ...
            items: [{
                ...
                info:   'MySQL snapshots contain a hotcopy of mysql data directory, file that holds binary log position and debian.cnf' +
                        '<br>' +
                        'When farm starts:<br>' +
                        '1. MySQL master dowloads and extracts a snapshot from storage depends on cloud platform<br>' +
        ...
        items: [{
            ...
            vtype: 'ebssize',
            getEbsType: function() {
                return this.up('#mysql').down('[name="mysql.ebs.type"]').getValue();
            },
            getEbsIops: function() {
                return this.up('#mysql').down('[name="mysql.ebs.iops"]').getValue();
            }
        }, {
            xtype: 'fieldcontainer',
            layout: 'hbox',
