Scalr.regPage('Scalr.ui.tools.gce.snapshots.view', function (loadParams, moduleParams) {
    ...
    return Ext.create('Ext.grid.Panel', {
        ...
        selModel: Scalr.isAllowed('GCE_SNAPSHOTS', 'manage') ? 'selectedmodel' : null,
        listeners: {
        ...
        dockedItems: [{
            ...
            afterItems: [{
                ...
                disabled: true,
                hidden: !Scalr.isAllowed('GCE_SNAPSHOTS', 'manage'),
                handler: function() {
                    var me = this,
                        request = {
                            confirmBox: {
                    ...
                    request.params = { snapshotId: Ext.encode(data)};
